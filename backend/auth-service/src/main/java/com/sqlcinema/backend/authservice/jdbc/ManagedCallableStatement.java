 ...
 * @author sozal
 */
public class ManagedCallableStatement implements CallableStatement {

    private final CallableStatement statement;

    public ManagedCallableStatement(CallableStatement statement) {
        this.statement = statement;
    }

    @Override
    public boolean execute() throws SQLException {
        if (ErrorInjector.shouldInjectDatabaseError()) {
            throw new SQLException("Database is not responding");
        }
