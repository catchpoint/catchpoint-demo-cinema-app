var generateUniqueID = function () {
        ...
        try {
            if (PerformanceObserver.supportedEntryTypes.includes(n)) {
                ...
                return r.observe(Object.assign({type: n, buffered: !0}, i || {})), r
            }
        } catch (u) {
        }
        return
    ...
    }, FCPThresholds = [1800, 3e3], getFCP = function (n, t) {
        whenActivated(function () {
            var f = getVisibilityWatcher(), i = initMetric("FCP"), r, e = function (n) {
        ...
        var t = performance.timing, i = performance.navigation.type,
            r = {entryType: "navigation", startTime: 0, type: i == 2 ? "back_forward" : i === 1 ? "reload" : "navigate"};
    ...
    }, bfcacheRestoreTime = -1, getBFCacheRestoreTime = function () {
        ...
        var r = getNavigationEntry(), i = "navigate";
    ...
    }, reportedMetricIDs = {}, LCPThresholds = [2500, 4e3], getLCP = function (n, t) {
        whenActivated(function () {
    ...
    }, CLSThresholds = [.1, .25], getCLS = function (n, t) {
        getFCP(runOnce(function () {
            var i = initMetric("CLS", 0), r, u = 0, f = [], e = function (n) {
                n.forEach(function (n) {
                    if (!n.hadRecentInput) {
                        var t = f[0], i = f[f.length - 1];
    ...
    }, interactionCountEstimate = 0, minKnownInteractionId = Infinity, maxKnownInteractionId = 0,
    ...
    }, MAX_INTERACTIONS_TO_CONSIDER = 10, longestInteractionList = [], longestInteractionMap = {},
    processEntry = function (n) {
        var r = longestInteractionList[longestInteractionList.length - 1], t = longestInteractionMap[n.interactionId],
            i;
        ...
        whenActivated(function () {
            ...
            var i = initMetric("INP"), r, f = function (n) {
                n.forEach(function (n) {
            ...
            }, u = observe("event", f, {durationThreshold: t.durationThreshold || 40});
...
var AjaxTiming = function () {
    ...
    function n() {
        ...
        var n = this, t, i;
        this.restUrl = "g.3gl.net/jp/10843/v3.3.9/M";
        ...
        this.setINP = function (t) {
            var i = t.name, r = t.value, u = i === "INP" ? r : undefined;
            n.inp = u
        };
        ...
        this.getCPWebVitals = function () {
            return getCLS(n.setCLS, !1), getLCP(n.setLCP, !1), getINP(n.setINP, {reportAllChanges: !1}), {
                cls: n.cls,
                lcp: n.lcp,
                inp: n.inp
            }
        ...
        this.attachIframe = function () {
            var r = window.location.protocol, t = document.createElement("iframe"), i;
            t.src = "about:blank";
            i = t.style;
            i.position = "absolute";
            i.top = "-10000px";
        ...
        getINP(this.setINP, {reportAllChanges: !1});
